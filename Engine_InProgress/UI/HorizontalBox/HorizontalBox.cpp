    ...
    if (requestAlignmentRender)
    {
        ...
        case Alignment::UpperLeft:
        {
            ...
            if (widget_children.size() == 1)
            {
                ...
                {
                    widget_children[0]->widget_transform.size.x += containerWidth - widget_children[0]->widget_transform.size.x;
                ...
                if (vertical_stretch)
                {
                    widget_children[0]->widget_transform.size.y += containerHeight - widget_children[0]->widget_transform.size.y;
            ...
            else if (widget_children.size() > 1)
            {
                ...
                // Counting additional size in order to stretch all the elements
                float widthToAddToEachElement = 0.f;
